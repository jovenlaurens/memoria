...
import Html exposing (Html, button, br, div, text)
...
render_ui_button cstate =
    let
        ...
        hint =
            Button 40 20 20 10 "Hint" (StartChange RecallMemory) "block"
...
render_hint =
    div
        ...
        [ text "First Floor"
        , br [][]
        , text "I feel thirsty right now, maybe I should find something to drink on the table"
        , br [][]
        , text "The room feels too dark, need some light"
        , br [][]
        , br [][]
        , text "Second Floor"
        , br [][]
        , text "The table feels too dark, need some light"
        , br [][]
        , text "I can hear something inside the doll"
        , br [][]
        , br [][]
        , text "Basement"
        , br [][]
        , text "The electricity is down, there must be a way to turn it on"
        , br [][]
        , text "This picture doesn't seem right. Someone need to rearrange it"
        , br [][]
        ]
