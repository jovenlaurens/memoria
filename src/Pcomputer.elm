...
drawnumberbutton number = 
    let
        tp = String.fromInt (650 + 50 * Tuple.first number.position)
        lp = String.fromInt (350 + 50 * Tuple.second number.position) 

        rnumber = (Tuple.first number.position) + 3 * ((Tuple.second number.position) - 1)
