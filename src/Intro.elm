module Intro exposing
    ...
    , FinishSit(..), IntroPage, initial_end, get_new_end, render_end
    )
...
render_end chse end =
    case chse of
        0 ->
            ...
            , button (if end.cp == 10 then 100 else 10) --!!!
            ]
        1 ->
            end_back ++
...
end_base_1 ind =
    case ind of
        ...
        9 ->[ text "After reading it, I remember everything."
            , br [][], br [][]
...
end_base_2 ind =
    case ind of
        ...
        9 ->[ text "Wait, it's just like a misapprehension?"
            , br [][], br [][]
